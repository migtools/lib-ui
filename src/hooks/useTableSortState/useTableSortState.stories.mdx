...
Does not require PatternFly, but integrates well with [PatternFly's table components](https://www.patternfly.org/v4/components/table/).
...
This hook can be used together with `usePaginationState`. See [this example](#composing-usetablesortstate-with-usepaginationstate).
...
Pagination should be the last thing you do to your data before rendering it. See [this example](#composing-usetablesortstate-with-usepaginationstate).
